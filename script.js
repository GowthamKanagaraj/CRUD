...
const readUi=function(){
    ...
    <button class="btn-update"onclick = updateItem(${task.id}) ><i class="fa-sharp fa-regular fa-pen-to-square"></i></button>
    <button class="btn-delete" onclick = deleteItem(${task.id})><i class="fa-sharp fa-solid fa-trash"></i></button>`;
